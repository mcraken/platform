...
import org.cradle.datetime.dateback.WeeksDateBackStrategy;
import org.cradle.datetime.dateback.WindowDateBackStrategy;
...
import org.cradle.schedule.quartz.builder.schedule.DailyScheduleBuilder;
import org.cradle.schedule.quartz.builder.schedule.QuartzScheduleBuilder;
import org.cradle.schedule.quartz.builder.schedule.SecondlyScheduleBuilder;
import org.cradle.schedule.quartz.builder.schedule.WeeklyScheduleBuilder;
...
public class QuartzJobBuilder implements JobBuilder {
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.ScheduleBuilder#scheulde()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#scheulde(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#secondly(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#secondly(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.ScheduleBuilder#daily()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#weekly(int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#ignoreMisfires()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#runOnceOnMisfire()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.schedule.JobBuilder#inTimeZone()
	 */
	@Override
