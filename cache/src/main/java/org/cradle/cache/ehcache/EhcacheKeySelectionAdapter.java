...
import org.cradle.cache.SelectionAdapter;
...
public class EhcacheKeySelectionAdapter extends EhcacheSelectionAdapter implements KeySelectionAdapter {
	...
	/* (non-Javadoc)
	 * @see org.cradle.cache.SelectionAdapter#page(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.cache.KeySelectionAdapter#eq(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.cache.KeySelectionAdapter#in(java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cradle.cache.KeySelectionAdapter#orderBy(boolean)
	 */
	@Override
